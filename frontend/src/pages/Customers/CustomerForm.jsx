...
import { MdArrowBack, MdPhotoCamera, MdAdd, MdDelete } from 'react-icons/md';
...
const CustomerForm = () => {
    ...
    const fetchCustomer = async () => {
        try {
            ...
            setFormData({
                ...
                products: data.customer.products || [{ productName: '', productCategory: '', productSerialNumber: '', productPhoto: null, customCategory: '' }]
            });
        } catch (error) {
    ...
    const handleProductSelection = (index, val) => {
        ...
        if (matchedProduct) {
            ...
            // Auto sum prices if multiple products are added
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Process custom categories in products
            submitData.products = submitData.products.map(p => {
                ...
                delete prod.customCategory; // cleanup
                return prod;
            });
                                        ...
                                        <div className="md:col-span-2">
                                            ...
                                            <div className="flex items-center gap-4 bg-white p-4 rounded-xl border border-gray-200">
                                                ...
                                                <div className="text-sm text-gray-500">
                                                    <p>This photo is automatically pulled from the Products inventory when selecting a product name.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
